        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-border">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-6">
              ...
              {/* WhatsApp */}
              <div className="text-center">
                <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-2">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="bg-card p-2 rounded-lg inline-block">
                  <QRCodeSVG value={socialLinks.whatsapp} size={80} bgColor="transparent" fgColor="hsl(var(--foreground))" />
                </div>
              </div>
            </div>
          </div>
