            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  João Pessoa, capital da Paraíba, é conhecida como a "Porta do Sol" por ser a cidade mais oriental das Américas. Com praias urbanas de águas mornas, arrecifes naturais, um centro histórico rico e a famosa Ponta do Seixas — o ponto mais oriental do continente americano — a cidade combina natureza, cultura e tranquilidade em um só lugar. É uma das capitais mais arborizadas do Brasil.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    { name: "Ponta do Seixas", desc: "O ponto mais oriental das Américas, onde o sol nasce primeiro. Vista deslumbrante do farol e do oceano." },
                    { name: "Praia de Tambaba", desc: "Praia com falésias e piscinas naturais, conhecida por ser a primeira praia oficial de naturismo do Nordeste." },
                    { name: "Centro Histórico", desc: "Igrejas barrocas, casarões coloniais e o Convento de São Francisco, patrimônio cultural da humanidade." },
                    { name: "Picãozinho", desc: "Piscinas naturais formadas por corais a 1,5 km da costa, acessíveis de catamarã na maré baixa." },
                    { name: "Praia de Coqueirinho", desc: "Uma das praias mais bonitas do litoral sul, com falésias avermelhadas e águas transparentes." },
                    { name: "Pôr do Sol na Praia do Jacaré", desc: "Tradição local com o som do Bolero de Ravel tocado ao saxofone durante o pôr do sol no rio." },
                  ].map((spot) => (
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  João Pessoa tem clima tropical com sol praticamente o ano todo. A melhor época é de <strong>setembro a fevereiro</strong>, quando chove menos e as temperaturas ficam entre 27°C e 31°C. O período de março a agosto tem mais chuvas, mas normalmente são passageiras e não impedem os passeios. A temperatura do mar é agradável durante todo o ano.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  A gastronomia pessoense é rica e diversificada. Destaque para o rubacão (prato típico com feijão verde, charque e queijo coalho), a macaxeira com carne de sol, os frutos do mar frescos e o caranguejo. Na orla, os quiosques servem petiscos deliciosos acompanhados de sucos de frutas regionais como cajá, mangaba e graviola.
                </p>
              </div>
            </div>
              ...
              <div className="bg-card rounded-2xl shadow-card p-6 sticky top-28 space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-muted-foreground">
                    ...
                    <span>8 dias • 29/03/26 a 05/04/26</span>
                  </div>
                  <div className="flex items-center gap-3 text-muted-foreground">
