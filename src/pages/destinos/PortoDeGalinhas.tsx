            ...
            <div>
              <div className="bg-card rounded-2xl shadow-card p-6 sticky top-28 space-y-6">
                ...
                <Button variant="hero" size="lg" className="w-full" asChild>
                  <a
                    href={`https://wa.me/5531972391400?text=${encodeURIComponent(SHOW_TRIP_INFO ? "Olá! Tenho interesse no pacote para Porto de Galinhas (09/08/26 a 16/08/26)" : "Olá! Tenho interesse no pacote para Porto de Galinhas")}`}
                    target="_blank"
                ...
                <ShareWhatsAppButton
                  ...
                  highlight={SHOW_TRIP_INFO ? "A partir de R$ 2.250 • Saindo de BH" : undefined}
                  kind="destino"
                />
