            ...
            <div>
              <div className="bg-card rounded-2xl shadow-card p-6 sticky top-28 space-y-6">
                ...
                <Button variant="hero" size="lg" className="w-full" asChild>
                  <a href="https://wa.me/5531991292442?text=Olá! Tenho interesse no pacote para Gramado - Dia dos Namorados (11/06/26 a 17/06/26)" target="_blank" rel="noopener noreferrer">
