...
const Gramado = () => {
  useSeo({ title: "Pacote Gramado | Marshe Viagens - Saindo de BH", description: "Pacote de viagem para Gramado e Canela, RS. Mini Mundo, Lago Negro, vinícolas e fondue. Aéreo, hospedagem e traslados.", canonical: "https://marsheviagens.com/destinos/gramado",
    ogParams: {
      ...
      highlight: "A partir de R$ 2.640 • Saindo de BH",
      kind: "Destino",
    }, });
  return (
            ...
            <div>
              <div className="bg-card rounded-2xl shadow-card p-6 sticky top-28 space-y-6">
                ...
                {SHOW_TRIP_INFO && (<div className="border-t border-border pt-4">
                  ...
                  <p className="text-3xl font-bold text-primary">R$ 2.640</p>
                ...
                <Button variant="hero" size="lg" className="w-full" asChild>
                  <a href={`https://wa.me/5531972391400?text=${encodeURIComponent(SHOW_TRIP_INFO ? "Olá! Tenho interesse no pacote para Gramado (28/07/26 a 01/08/26)" : "Olá! Tenho interesse no pacote para Gramado")}`} target="_blank" rel="noopener noreferrer">
                    Reservar pelo WhatsApp
                  </a>
                </Button>
                <ShareWhatsAppButton
                  title="Pacote Gramado — Marshe Viagens"
                  highlight={SHOW_TRIP_INFO ? "A partir de R$ 2.640 • Saindo de BH" : undefined}
                  kind="destino"
                />
