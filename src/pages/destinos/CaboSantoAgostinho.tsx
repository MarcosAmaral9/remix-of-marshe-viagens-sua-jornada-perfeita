...
const CaboSantoAgostinho = () => {
  useSeo({
    ...
    description:
      "Pacote de viagem para Cabo de Santo Agostinho, PE. Praia de Calhetas, piscinas naturais e mais, saindo de BH.",
            ...
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Cabo de Santo Agostinho é um paraíso escondido no litoral sul de Pernambuco, a apenas 35 km de Recife.
                  Com praias de águas mornas e cristalinas, piscinas naturais formadas por recifes de coral e uma rica
                  história colonial, o destino encanta visitantes em busca de tranquilidade e beleza natural. A região
                  abriga algumas das praias mais bonitas do Nordeste brasileiro, muitas delas ainda preservadas do
                  turismo de massa.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  o clima é mais seco e ensolarado. Os meses de dezembro a fevereiro são os mais quentes, com
                  temperaturas entre 28°C e 32°C. De abril a agosto ocorre a temporada de chuvas, mas ainda é possível
                  aproveitar dias de sol. A temperatura da água do mar se mantém agradável o ano inteiro, entre 26°C e
                  29°C.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  A culinária local é rica em frutos do mar. Experimente a lagosta grelhada, o peixe na telha, a
                  caldeirada e o tradicional bolo de rolo pernambucano. Os quiosques à beira-mar oferecem petiscos
                  frescos e sucos de frutas tropicais. Não deixe de provar a tapioca recheada e o famoso cartola,
                  sobremesa típica feita com banana e queijo coalho.
                </p>
              </div>
            </div>
